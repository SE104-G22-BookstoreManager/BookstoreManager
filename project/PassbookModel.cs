...
namespace PassbookManagement
{
	public static class PassbookModel
	{
		...
		public static DataTable SelectAllDeposit()
		{
			string _query = "SELECT * FROM " + tbl_incomes;
			return Database.SQLiteDatabase.GetDataTable(_query);
		}

		public static DataTable SelectAllWithdrawal()
		{
		...
		public static DataTable SelectPassbookById(string id_passbook)
		{
		...
		public static bool UpdateCashByPassbookId(string id_passbook, string money)
		{

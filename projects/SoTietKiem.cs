...
namespace PassbookManagement
{
    public partial class SoTietKiem : Form
    {
        ...
        public SoTietKiem()
        {
            ...
            m_database = new SQLiteDatabase("CNPM.s3db");
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            m_database.Insert("SoTietKiem", CreateDictionary(txt_MaSo.Text, txt_MKH.Text, txt_hoten.Text, txt_cmnd.Text, txt_diachi.Text, txt_tiengui.Text, txt_ngaygui.Text, TietKiemLoai));
        }
        public Dictionary<string, string> CreateDictionary(string MaSo, string MA_KHANG, string HoTenKH, string CMND, string DiaChi, string SoTienGui, string NgayMoSo, string MaLoaiTietKiem)
        {
